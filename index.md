...
#        alt: Permitted Services
    - infopic:
        ...
        subtitle:      
        description: For assistance on Job Support Scheme.<br/><a herf="https://go.gov.sg/jss" rel="noreferrer" target="_blank" class="bp-sec-button margin--top padding--bottom">Find Out More</a><br/>For other list of assistance that Government is providing.
        button: Find Out More
