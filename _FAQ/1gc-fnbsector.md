...
#### **5. Do I need to apply for an exemption to resume operations for Phase Two?**
...
#### **6. What are the safe management measures F&B establishments need to implement for dine-in?**
...
#### **7. Can F&B establishments use acrylic dividers or physical barriers to replace the need for 1m safe distancing?**
...
#### **8. I own a F&B establishment within a mall. Am I required to implement SafeEntry and conduct temperature taking/checks on visible symptoms, since visitors who entered the malls are already required to do so?**
...
#### **9. What are the visible symptoms to check for and how should I check this?**
...
#### **10. Are we allowed to hold sales and promotional activities within our F&B outlets?**
...
#### **11. Can I leave the cutleries and condiments on the dining table or placed at a common station for the customers to self-serve?**
...
#### **12. Are F&B establishments allowed to operate the entertainment/amusement devices (such as billiard, pool tables, dart machines) within their outlet? Amusement and leisure centres such as billiard and pool centres can already resume operations, and some even provide F&B.**
...
#### **13. Can my restaurant now accept group sizes bigger than 8, as long as we sit them in groups of 8 or less? And for such groups bigger than 8, must they be from the same household?**
...
#### **14. Can F&B establishments request to check the identification cards of the groups of diners if they claim to be from the same household?**
...
#### **15. Are there guidelines for diners on when they can remove their mask and how soon would they need to put it back on?**
...
#### **16. Can F&B establishments serve alcohol? If so, can the bar counters in the restaurants be opened?**
...
#### **17. Can F&B establishments without a retail licence serve alcohol for takeaway or delivery?**
...
#### **18. Why is there a limit of 60 decibels set for the volume of the background music played in my F&B establishment? What is the basis of this?**
...
#### **19. I am a licensed food caterer and understand that self-service buffet lines are not allowed currently. Am I allowed to provide food catering services at a funeral related event such as wake, where the food is handled and served by my staff, or that it is individually packed for the attendees?**
...
#### **20. Self-service buffet lines are still not allowed. What if I have service staff to man the buffet line?**
...
#### **21. The Chinese New Year period is coming up. Can retailers hold pop-ups to sell their products, outside of their premises or at mall atriums?**
...
#### **22. Can I give out food samples to my customers during Chinese New Year?**
...
#### **23. All malls and large standalone stores (>930sqm) must comply with the occupancy limit of 8 sqm per person stipulated. What is the basis for this?**
...
#### **24. How should malls and standalone stores compute the number of people allowed in their premises based on the occupancy limit of one person per 8 sqm of Gross Floor Area (GFA)?**
...
#### **25. How can a mall/ standalone store manage the number of shoppers to ensure compliance with the occupancy limit of one person per 8 sqm of Gross Floor Area (GFA)?**
...
#### **26. With more shops opening, crowds are coming back. How else can I better control the crowd level in my store?**
...
#### **27. Are in-store and mall promotions e.g. sales and special offers allowed?**
...
#### **28. Are in-store events and activities or mall atrium activities allowed?**
Activities and events at mall atriums must not be held.

#### **29. When will we know if atrium sales can resume?**
Atrium sales are not permitted until further notice.

#### **30. What are the visible symptoms to check for and how should I check this? As a mall operator, can I turn away all customers who appear unwell?**
Notable visible symptoms to look out for include: (a) coughing; (b) sneezing; (c) breathlessness; and (d) a runny nose.
...
#### **31. Will malls be held accountable if their tenants do not comply with the safe management measures?**
...
#### **32. Do retailers need to apply for permission if they intend to organise in-store or mall promotions e.g. sales and special offers? What guidelines do they have to follow when organising such activities?**
...
#### **33. For retailers who have to cross-deploy their staff, what are the additional safeguards that they have to put in place to minimise the risk of cross infection?**
...
#### **34. Are testers and samples allowed?**
...
#### **35. Can communal water-based facilities such as showers/spas/saunas/jacuzzi facilities be used?**
...
#### **36. As an operator of make-up or facial therapy services, what additional precautions should I take for my employees, as my customers are unable to wear a face mask during these services?**
...
#### **37. Do customers need to wear a face mask for facial hair grooming/facial threading services?**
...
#### **38. Are paid kiddy rides/indoor playgrounds/family entertainment centres permitted to resume operations?**
...
#### **39. Are common play areas for children in F&B/retail shops/malls allowed to open?**
...
#### **40. Are indoor kids’ playgrounds and leisure centres in malls allowed to open?**
...
#### **41. Are game arcades/claw machines permitted to resume operations?**
...
#### **42. Are vending machines permitted to open?**
Yes, vending machines are permitted to open.

#### **43. Are retail businesses who conduct their businesses from their outdoor display areas outside their retail shops permitted to resume operations?**
...
#### **44. Are home-based beauty salons allowed to reopen? Is there an advisory for home-based beauty salon businesses?**
...
#### **45. Are there guidelines for saunas, especially large-format spas and saunas?**
...
#### **46. Can customers share private therapy rooms?**
...
#### **47. Should malls continue to demarcate lifts with one-metre spacing?**
...
#### **48. Are kiosks and push-carts permitted to resume operations?**
...
#### **49. Are unmanned massage chairs in malls allowed to operate?**
...
#### **50. Can shoppers remove their masks and sit at common areas to consume takeaway food?**
...
#### **51. For retail stores that are currently under renovation and are taking up a temporary lease at atrium space, can they operate?**
...
#### **52. The main walkway to office block passes through some retail units (facing corridor), do workers still need to do SafeEntry and temperature checks?**
...
#### **53. Can designated smoking areas (DSAs) be reopened?**
