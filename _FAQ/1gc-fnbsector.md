...
Entertainment/amusement devices (e.g. dart machines, billiard, pool tables) in F&B establishments must remain closed as these are not the core services provided by the F&B establishments. Such facilities will result in longer than unnecessary dwell time, and result in crowds or congregation. We urge the cooperation of F&B establishments as we work towards the gradual resumption of activities, to provide a safe environment for customers and employees.
...
Gatherings and events involving more than 5 persons are not allowed at F&B establishments. Exceptions can only be made if all members of the group are from the same household. They must be seated across tables of no more than 5 persons per table, with at least one-metre spacing between groups.
...
#### **15. All malls and large standalone stores (>930sqm) must comply with the occupancy limit of 10 sqm per person stipulated. What is the basis for this?**
...
#### **16. How should malls and standalone stores compute the number of people allowed in their premises based on the occupancy limit of one person per 10 sqm of Gross Floor Area (GFA)?**
...
#### **17. How can a mall/ standalone store manage the number of shoppers to ensure compliance with the occupancy limit of one person per 10 sqm of Gross Floor Area (GFA)?**
...
#### **18. With more shops opening, crowds are coming back. How else can I better control the crowd level in my store?**
...
#### **19. Are in-store and mall promotions e.g. sales and special offers, allowed in Phase Two?**
...
#### **20. Are in-store events and activities or mall atrium activities allowed?**
Activities and events in stores or mall atriums must not be held.

#### **21. When will we know if atrium sales can resume?**
Atrium sales are not permitted until further notice.

#### **22. Why are promotions by supermarkets allowed when retail in-store and mall promotions are not allowed for at least 2 weeks from Phase Two reopening?**
...
#### **23. What are the visible symptoms to check for and how should I check this? As a mall operator, can I turn away all customers who appear unwell?**
Notable visible symptoms to look out for include: (a) coughing; (b) sneezing; (c) breathlessness; and (d) a runny nose.
...
#### **24. Will malls be held accountable if their tenants do not comply with the safe management measures?**
...
#### **25. Do retailers need to apply for permission if they intend to organise in-store or mall promotions e.g. sales and special offers, after 2 weeks of reopening? What guidelines do they have to follow when organising such activities after the 2-week period?**
...
#### **26. For retailers who have to cross-deploy their staff, what are the additional safeguards that they have to put in place to minimise the risk of cross infection?**
...
#### **27. Are testers and samples allowed?**
All product testers and samples that require customer contact e.g. cosmetics and food samples, must be removed.

#### **28. Can communal water-based facilities such as showers/spas/saunas/jacuzzi facilities be used?**
...
#### **29. As an operator of make-up or facial therapy services, what additional precautions should I take for my employees, as my customers are unable to wear a face mask during these services?**
...
#### **30. Do customers need to wear a face mask for facial hair grooming/facial threading services?**
...
#### **31. Are paid kiddy rides/indoor playgrounds/family entertainment centres permitted to resume operations?**
...
#### **32. Are common play areas for children in F&B/retail shops/malls allowed to open?**
...
#### **33. Are indoor kids’ playgrounds and leisure centres in malls allowed to open?**
...
#### **34. Are game arcades/claw machines permitted to resume operations?**
...
#### **35. Are vending machines permitted to open?**
Yes, vending machines are permitted to open.

#### **36. Are retail businesses who conduct their businesses from their outdoor display areas outside their retail shops permitted to resume operations?**
...
#### **37. Are home-based beauty salons allowed to reopen? Is there an advisory for home-based beauty salon businesses?**
...
#### **38. Are there guidelines for saunas, especially large-format spas and saunas?**
...
#### **39. Can customers share private therapy rooms?**
...
#### **40. Should malls continue to demarcate lifts with one-metre spacing?**
...
#### **41. Are kiosks and push-carts permitted to resume operations?**
...
#### **42. Are unmanned massage chairs in malls allowed to operate?**
...
#### **43. Can shoppers remove their masks and sit at common areas to consume takeaway food?**
...
#### **44. For retail stores that are currently under renovation and are taking up a temporary lease at atrium space, can they operate in Phase 2?**
...
#### **45. The main walkway to office block passes through some retail units (facing corridor), do workers still need to do SafeEntry and temperature checks?**
...
#### **46. Can designated smoking areas (DSAs) be reopened?**
